...
export const asyncRouterMap = [
  {
    ...
    name: 'pms',
meta: {title: 'commodity', icon: 'product'},
    children: [{
      path: 'product',
      name: 'product',
...
meta: {title: 'Add item', icon: 'product-add'}
      },
      {
        path: 'updateProduct',
        name: 'updateProduct',
        component: () => import('@/views/pms/product/update'),
meta: {title: 'Modify item', icon: 'product-add'},
        hidden: true
      },
      {
        path: 'productCate',
...
meta: {title: 'ItemType ', icon:' product-attr '}
      },
      {
...
meta: {title: 'Return Request Handling', icon: 'order-return'}
      },
      {
        path: 'returnReason',
        name: 'returnReason',
...
meta: {title: 'Lightning Event List', icon: 'sms-flash'}
      },
      {
        path: 'flashSession',
        name: 'flashSession',
        component: () => import('@/views/sms/flash/sessionList'),
meta: {title: 'List of seconds kill time'},
        hidden:true
      },
      {
        path: 'selectSession',
...
meta: {title: 'seconds kill time slot selection'},
        hidden:true
      },
      {
...
meta: {title: 'List of Lightning Deals'},
        hidden:true
      },
      {
        path: 'coupon',
...
meta: {title: 'Coupon Redemption Details'},
        hidden:true
      },
      {
        path: 'brand',
...
meta: {title: 'Brand recommended', icon: 'product-brand'}
      },
      {
        path: 'new',
        name: 'homeNew',
        component: () => import('@/views/sms/new/index'),
meta: {title: 'New recommende', icon: 'sms-new'}
      },
      {
        path: 'hot',
        name: 'homeHot',
        component: () => import('@/views/sms/hot/index'),
meta: {title: 'Top Recommende', icon: 'sms-hot'}
      },
      {
        path: 'subject',
        name: 'homeSubject',
        component: () => import('@/views/sms/subject/index'),
meta: {title: 'Thematic recommende', icon: 'sms-subject'}
      },
      {
        path: 'advertise',
        name: 'homeAdvertise',
...
//mode: 'history', //terminal support open
  scrollBehavior: () => ({y: 0}),
