...
title= “public number QR code”
      ...
      width="30%">
      <div style="text-align: center">
<span class="font-title-large"> <span class="color-main font-extra-large">Follow the public number</span>reply <span class="color-main font-extra-large">Experience</span>Get Experience Account</span>
        <br>
...
callback (new Error ('Please enter a correct username '))
        } else {
          callback()
        }
      };
