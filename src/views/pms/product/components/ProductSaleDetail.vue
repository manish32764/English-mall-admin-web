...
<el-checkbox: label= "1">Worries Free Returns</el-checkbox>
...
<el-radio-button: label= "0">No Offer</el-radio-button>
...
<el-radio-button: label= "4">Full Price Reduction</el-radio-button>
        </el-radio-group>
      </el-form-item>
...
//Date chunker configuration
    ...
    computed: {
//Warranty of the garment in the
      selectServiceList: {
        get() {
          let list = [];
    ...
    methods: {
      ...
      handleAddProductLadder(index, row) {
        ...
        if (productLadderList.length < 3) {
          ...
          this.$message({
message: 'You can only add up to three ',
            type: 'warning'
          });
        }
      },
