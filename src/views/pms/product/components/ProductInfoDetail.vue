...
//value of product segmentation in the
...
subTitle: [{required: true, message: 'Please enter product subtitle ', trigger:' blur '}],
productCategoryId: [{required: true, message: 'Please select product category ', trigger:' blur'}],
brandId: [{required: true, message: 'Please select brand of merchandise ', trigger:' blur '}],
