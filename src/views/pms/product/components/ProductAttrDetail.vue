...
@click ="handleRefreshProductSkuList "> Refresh List
        ...
        <el-button
          type="primary"
          style="margin-top: 20px"
@click ="handleSyncProductSkuPrice "> Synchronization Price
        </el-button>
        <el-button
          type="primary"
          style="margin-top: 20px"
...
<script>
  ...
  export default {
    ...
    data() {
      return {
//whether or not the initialization is successful
        hasEditCreated:false,
//Commodity drop down item
        productAttributeCategoryOptions: [],
//Product inability in the
        selectProductAttr: [],
//number of products in
        selectProductParam: [],
//product in the
        selectProductAttrPics: [],
//goods that can be added by hand
        addProductAttrValue: '',
//commodity rich text activation type
        activeHtmlName: 'pc'
      }
    },
    computed: {
//whether there is a product slices
      hasAttrPic() {
...
//the main owner and the pint of the product
      selectProductPics:{
        get:function () {
          let pics=[];
    ...
    methods: {
      handleEditCreated() {
//Root commodity classification id. extract the value and number of
...
//
            ...
            if(this.isEdit){
//Refresh products in the mode of
            ...
            for (let i = 0; i < list.length; i++) {
              let value=null;
              if(this.isEdit){
//Obtain the anomaly in the anomaly mode
...
//add the value of the ability to remove the hand of the disposal
...
//Retrieve the values of the intractable
...
message: 'Property value cannot be null',
        ...
        if (options.indexOf(this.addProductAttrValue) !== -1) {
          this.$message({
message: 'Property values cannot be duplicated',
            type: 'warning',
            duration: 1000
          });
          return;
...
this. $confirm ('Refresh list will cause sku information to be regenerated, whether to refresh ', 'Prompt', {
...
this. $confirm ('will synchronize the price of the first sku to all sku, whether to continue ',' prompt ', {
confirmButtonText: 'Ode',
cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
...
this. $confirm ('will synchronize the first sku inventory to all sku, whether to continue ',' prompt ', {
confirmButtonText: 'Ode',
cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
...
//When there is only one resistance
...
//Obtain the product's resistance to the fragment
...
//composites of the products of the slices
