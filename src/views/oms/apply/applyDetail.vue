...
<span class="font-title-medium">Returned-Item</span>
      <el-table
        border
...
<span class="font-small">No.: NO. {{scope.row.productId}}</span>
          </template>
        </el-table-column>
...
<span class="font-title-medium">AGAINS:</span>
        <span class="font-title-medium color-danger">￥{{totalAmount}}</span>
      </div>
    </el-card>
    <el-card shadow="never" class="standard-margin">
<span class="font-title-medium">Service List Information</span>
      <div class="form-container-border">
        <el-row>
<el-col: span= "6" class=" form-border form-left-bg font-small ">Service List Number </el-col>
