...
<el-input v-model="listQuery.productName" class="input-width" placeh older="Product Name"> </el-input>
          </el-form-item>
...
<span>Data List</span>
<el-button size="mini" class="btn-add" @click ="handleSelectProduct () "> Select a product</el-button>
    </el-card>
