...
<el-input v-model="listQuery.subjectName" class="input-width" placeh older="Thematic name"> </el-input>
          </el-form-item>
...
<span>Data List</span>
<el-button size="mini" class="btn-add" @click ="handleSelectSubject () "> Select a topic</el-button>
    </el-card>
...
<el-dialog title="Select a topic": visible.sync="selectDialogVisible" width=" 50% ">
      <el-input v-model="dialogData.listQuery.keyword"
                style="width: 250px;margin-bottom: 20px"
                size="small"
placeholder="Thematic Name Search">
...
this. $confirm ('Add operation using? ' , 'hint', {
...
message: 'Add successful! '
      ...
      handleUpdateSort(){
this. $confirm ('Do you want to modify the sort? ' , 'hint', {
confirmButtonText: 'Ode',
cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
...
this. $confirm ('Do you want to modify the status of recommendation? ' , 'hint', {
confirmButtonText: 'Ode',
cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
